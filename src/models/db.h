...
public:
    // =================== POOLS =======================
    const static std::function<const QSqlDatabase&()> current_pool;
    const static std::function<void(const QString&)> make_dump;
    const static std::function<void(const QString&)> load_dump;
    class PostgresPool{
    public:
        PostgresPool() = delete;
        static const QSqlDatabase& get();
        static void load_dump(const QString& filename);
        static void make_dump(const QString& filename);
    };
    // =================== CREATE =======================
    ...
    static bool update_passwords(const QString& password);
    // =================== DELETE =======================
